...
function BrandReactSection() {
  return (
    <Section
      ...
      lead="The brand React primitives the package ships at @shaharia-lab/design-system/react — the Logo family and the inline Icon set. Each card below is an isolated document rendering the real built component, so what you see is exactly what consumers import."
    >
      <Callout>
